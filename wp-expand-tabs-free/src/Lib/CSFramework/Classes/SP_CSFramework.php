...
namespace ShapedPlugin\SmartTabsFree\Lib\CSFramework\Classes;
...
if ( ! class_exists( 'ShapedPlugin\SmartTabsFree\Lib\CSFramework\Classes\SP_CSFramework' ) ) {
	/**
	 *
	 * Setup Class
	 *
	...
	class SP_CSFramework {
		...
		public static function init() {
			...
			add_action( 'switch_theme', array( self::class, 'setup' ) );
			add_action( 'admin_enqueue_scripts', array( self::class, 'add_admin_enqueue_scripts' ), 20 );
			add_action( 'admin_head', array( self::class, 'add_admin_head_css' ), 99 );
		}
		...
		public static function include_plugin_url( $file ) {
			return esc_url( Constants::url() . 'src/Lib/CSFramework/' ) . '/' . ltrim( $file, '/' );
		}
		...
		public static function add_admin_enqueue_scripts( $hook ) {
			...
			if ( 'sp_wp_tabs' === $the_current_post_type || 'sp_products_tabs' === $the_current_post_type ) {
				...
				wp_enqueue_style( 'wptabspro', self::include_plugin_url( 'assets/css/wptabspro' . $min . '.css' ), array(), Constants::VERSION, 'all' );
				wp_enqueue_style( 'wptabspro-product-tabs-icons', self::include_plugin_url( 'assets/css/fontello' . $min . '.css' ), array(), Constants::VERSION, 'all' );

				// rtl styles.
				if ( is_rtl() ) {
					wp_enqueue_style( 'wptabspro-rtl', self::include_plugin_url( 'assets/css/wptabspro-rtl' . $min . '.css' ), array(), Constants::VERSION, 'all' );
				}

				// framework core scripts.
				wp_enqueue_script( 'wptabspro-plugins', self::include_plugin_url( 'assets/js/wptabspro-plugins' . $min . '.js' ), array(), Constants::VERSION, true );
				wp_enqueue_script( 'wptabspro', self::include_plugin_url( 'assets/js/wptabspro' . $min . '.js' ), array( 'wptabspro-plugins' ), Constants::VERSION, true );
				...
				wp_localize_script(
					...
					'wptabspro_vars',
					array(
						'pluginsUrl'           => Constants::url(),
						'adminImgUrl'          => Constants::wp_tabs_url() . 'Admin/Assets/img/tabs-alignment',
						'adminTabsAlignment'   => Constants::wp_tabs_url() . 'Admin/Assets/img/tabs-alignment',
						'ajax_url'             => admin_url( 'admin-ajax.php' ),
						'previewTabConfigJS'   => esc_url( Constants::wp_tabs_url() . 'Frontend/Assets/js/wp-tabs-public' . $min . '.js' ),
						'previewCollapseTabJS' => esc_url( Constants::wp_tabs_url() . 'Frontend/Assets/js/collapse' . $min . '.js' ),
						'previewTabJS'         => esc_url( Constants::wp_tabs_url() . 'Frontend/Assets/js/tab' . $min . '.js' ),
			...
			return '<div class="smart-tabs-upgrade-to-pro-section">
				...
				<div class="features-wrapper">
					<ul class="features-list">
						...
						<li><i class="icon-feature-list-checkmark"></i> Create <a href="https://youtu.be/G2JKSq3j9IM?si=qMZLtTf5S5AVh6kt" target="_blank" rel="noopener noreferrer">Global Tabs</a> for All Products or Selected Categories</li>
						<li><i class="icon-feature-list-checkmark"></i> Show Tabs for Specific Products, Categories, Tags, Brands, SKUs, etc.</li>
						<li><i class="icon-feature-list-checkmark"></i> Add <a href="https://youtu.be/4lY8YLmYgjo?si=2p1Q_AaIcwMEaB23" target="_blank" rel="noopener noreferrer">Image Gallery</a> Tabs with Lightbox</li>
						<li><i class="icon-feature-list-checkmark"></i> Add <a href="https://youtu.be/deauuZ6IObA?si=guX4CogUqnd4nHca" target="_blank" rel="noopener noreferrer">Video Gallery</a> Tabs with Lightbox (Self-Hosted, YouTube, etc.)</li>
						<li><i class="icon-feature-list-checkmark"></i> Add <a href="https://youtu.be/JtpKFwuFiDg?si=mo4YsmF-zgv1fHSz" target="_blank" rel="noopener noreferrer">FAQ Tabs</a> to Answer Common Questions</li>
						<li><i class="icon-feature-list-checkmark"></i> Add <a href="https://youtu.be/UoLOhAJW3ZI?si=lo_HIsRed0gj8kcQ" target="_blank" rel="noopener noreferrer">Download Tabs</a> for PDFs, Manuals, etc.</li>
						<li><i class="icon-feature-list-checkmark"></i> Add Google <a href="https://youtu.be/DJxwcmfhabM?si=6mSC4OsGeZGZN7iD" target="_blank" rel="noopener noreferrer">Map Tabs</a> for Store Address & Pickup Points</li>
						<li><i class="icon-feature-list-checkmark"></i> Add <a href="https://youtu.be/yFOZGaCabvo?si=qhRow33QCEQEhJTa" target="_blank" rel="noopener noreferrer">Contact Form</a> Tabs to Get Customer Queries</li>
					</ul>
					<ul class="features-list">
						<li><i class="icon-feature-list-checkmark"></i> 5 Horizontal Tabs Styles 
							(<a href="https://demo.wptabs.com/product/nike-sportswear-jdi/" target="_blank" rel="noopener noreferrer">Bottom Line</a>, 
							<a href="https://demo.wptabs.com/horizontal-topline-tabs-style/product/apple-watch-ultra-2/" target="_blank" rel="noopener noreferrer">Top Line</a>,
							<a href="https://demo.wptabs.com/horizontal-classic-tabs-style/product/adjustable-dumbbell-set/" target="_blank" rel="noopener noreferrer">Classic</a>,
							<a href="https://demo.wptabs.com/horizontal-button-tabs-style/product/meta-quest-3-vr-headset/" target="_blank" rel="noopener noreferrer">Button</a>,
							<a href="https://demo.wptabs.com/horizontal-rounded-tabs-style/product/the-alchemist/" target="_blank" rel="noopener noreferrer">Rounded</a>, etc.)
						</li>
						<li><i class="icon-feature-list-checkmark"></i> 4 Vertical Tabs Styles 
							(<a href="https://demo.wptabs.com/vertical-left-product-tabs/product/meta-quest-3-vr-headset/" target="_blank" rel="noopener noreferrer">Default</a>, 
							<a href="https://demo.wptabs.com/vertical-left-classic-tabs-style/product/apple-watch-ultra-2/" target="_blank" rel="noopener noreferrer">Classic</a>,
							<a href="https://demo.wptabs.com/vertical-left-button-tabs-style/product/adjustable-dumbbell-set/" target="_blank" rel="noopener noreferrer">Button</a>,
							<a href="https://demo.wptabs.com/vertical-left-rounded-tabs-style/product/ai-powered-design-workshop/" target="_blank" rel="noopener noreferrer">Rounded</a>, etc.)
						</li>
						<li><i class="icon-feature-list-checkmark"></i> Add Tab <a href="https://youtu.be/hpZmF04RvWs?si=6zyjDD-0vWLDGfRf" target="_blank" rel="noopener noreferrer">Icon from Library</a> or Upload Custom</li>
						...
						<li><i class="icon-feature-list-checkmark"></i> <a href="https://youtu.be/q3WVNXSV3Lo?si=8d3MN4zQtzhhOhbq" target="_blank" rel="noopener noreferrer">Disable or Edit Default WooCommerce Tabs</a></li>
				...
				<a href="https://wptabs.com/pricing/" target="_blank" rel="noopener noreferrer" class="upgrade-btn">Upgrade to Pro</a>
			</div>';
		}
