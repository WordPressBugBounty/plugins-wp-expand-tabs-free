...
if ( is_array( $sptpro_post_data_src ) ) {
	...
	if ( $post_query->have_posts() ) {
		...
		while ( $post_query->have_posts() ) {
			...
			include Constants::src_path() . 'Modules/WPTabs/Frontend/partials/tab-post/post-meta.php';
	...
	if ( $post_query->have_posts() ) {
		while ( $post_query->have_posts() ) {
			...
			$smooth_scrollbar    = '';
			include Constants::src_path() . 'Modules/WPTabs/Frontend/partials/tab-post/post-meta.php';
			include Constants::src_path() . 'Modules/WPTabs/Frontend/partials/tab-post/feature-image.php';
