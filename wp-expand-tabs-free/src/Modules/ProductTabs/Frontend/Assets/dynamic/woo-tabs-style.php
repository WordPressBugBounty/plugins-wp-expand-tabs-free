...
if ( ! $show_tab_heading_inside_tab ) {
	$dynamic_style .= '
    html body.woocommerce.sptpro-smart-tabs .woocommerce-tabs.wc-tabs-wrapper .woocommerce-Tabs-panel>h2:first-of-type,
    html body.woocommerce.sptpro-smart-tabs .woocommerce-tabs.wc-tabs-wrapper .woocommerce-Tabs-panel h2.woocommerce-Reviews-title {
        display: none;
    }';
}
