...
namespace ShapedPlugin\SmartTabsFree\Integration\ElementorAddons;
...
use ShapedPlugin\SmartTabsFree\Integration\ElementorAddons\Widgets\ShortcodeWidget;
...
class Elementor_Addon {
	...
	public function sp_tabs_addons_icon() {
		wp_enqueue_style( 'sp_tabs_elementor_addons_icon', Constants::url() . 'src/Integration/ElementorAddons/assets/elementor-icon.min.css', array(), Constants::VERSION, 'all' );
	}
	...
	public function init_widgets() {
		// Register widget.
		\Elementor\Plugin::instance()->widgets_manager->register( new ShortcodeWidget() );
	}
}
