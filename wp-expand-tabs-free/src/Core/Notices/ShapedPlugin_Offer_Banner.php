<?php
/**
 * This fiile is responsible to generate admin offer banners.
 *
 * @since        2.2.7
 *
	...
	public function get_active_offers() {
		...
		$offers = array(
			'black_friday' => array(
				...
				'image' => Constants::url() . 'src/Core/Notices/Images/bfcm-offer-banner.svg',
				'link'  => 'https://wptabs.com/pricing/?campaign=stabs&ref=423',
			),
			'new_year'     => array(
				'id'    => 'new_year_2026',
				'start' => strtotime( '2025-12-26 00:00:00' ),
				'end'   => strtotime( '2026-01-14 23:59:59' ),
				'image' => Constants::url() . 'src/Core/Notices/Images/new-year-offer-banner.svg',
				'link'  => 'https://wptabs.com/pricing/?campaign=stabs&ref=423',
			),
		);
