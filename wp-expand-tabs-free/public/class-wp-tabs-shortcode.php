...
class WP_Tabs_Shortcode {
	 ...
	 */
	public static function sp_tabs_html_show( $post_id, $sptpro_data_upload, $sptpro_shortcode_options, $main_section_title ) {
		...
		if ( 'content-tabs' === $sptpro_tab_type ) {
			include WP_TABS_PATH . '/public/partials/tab-custom/content.php';
		} else {
			include WP_TABS_PATH . '/public/partials/tab-post/tabs-post.php';
		}
		?>
		</div>
		<?php
